...
knitr::include_graphics("https://github.com/romina-gonzalez-musso/Severidad_IncendioLagoMartin/blob/master/_images/3_Ci.png?raw=true")
```
...
```{r, echo=FALSE, out.width="90%", fig.cap=""}
knitr::include_graphics("https://github.com/romina-gonzalez-musso/Severidad_IncendioLagoMartin/blob/master/_images/3_Mx.png?raw=true")
```
...
```{r, echo=FALSE, out.width="90%", fig.cap=""}
knitr::include_graphics("https://github.com/romina-gonzalez-musso/Severidad_IncendioLagoMartin/blob/master/_images/3_Le.png?raw=true")
```
...
```{r, echo=FALSE, out.width="90%", fig.cap=""}
knitr::include_graphics("https://github.com/romina-gonzalez-musso/Severidad_IncendioLagoMartin/blob/master/_images/3_Ni.png?raw=true")
```
...
```{r, echo=FALSE, out.width="90%", fig.cap=""}
knitr::include_graphics("https://github.com/romina-gonzalez-musso/Severidad_IncendioLagoMartin/blob/master/_images/3_ArbuNa.png?raw=true")
```